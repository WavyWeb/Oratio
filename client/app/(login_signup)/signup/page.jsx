    ...
    return (
        <section className="flex items-center justify-center min-h-screen px-4 static-bg relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10 fade-in">
                <div className="glass-bg rounded-3xl shadow-xl p-8 border border-gray-200 dark:border-slate-600 hover:border-amber-500/50 transition-all duration-300 relative overflow-hidden group">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div className="group">
                                ...
                                <input
                                    ...
                                    id="name"
                                    autoComplete="name"
                                    className="w-full px-4 py-3 text-sm glass-bg border border-gray-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/50 placeholder-gray-400 dark:placeholder-slate-500 text-slate-900 dark:text-white transition-all duration-200 hover:border-gray-300 dark:hover:border-slate-500"
