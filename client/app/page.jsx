...
const useCases = [
  { icon: "💼", title: "Job Interviews", desc: "Practice behavioral and technical interview answers with AI-scored feedback." },
  { icon: "🎓", title: "Academic Presentations", desc: "Prepare for thesis defenses, viva voce, and classroom presentations." },
  { icon: "📊", title: "Business Pitches", desc: "Refine your pitch delivery for investors, clients, and stakeholders." },
  { icon: "🎤", title: "Public Speaking", desc: "Build confidence for conferences, keynotes, and team meetings." },
];
        ...
        <button
          ...
          className={`h-2.5 rounded-full transition-all duration-300 ${
            i === active
              ...
              : "w-2.5 bg-gray-300 dark:bg-slate-600 hover:bg-gray-400 dark:hover:bg-slate-500"
          }`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Perfect For <span className="bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent">Every Scenario</span>
          </h2>
        </div>
        ...
        <InfiniteSlider
          ...
          autoInterval={3000}
          renderItem={(item) => (
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 md:p-8 text-center h-full">
              <div className="text-5xl mb-5">{item.icon}</div>
              <h3 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-3">{item.title}</h3>
              <p className="text-gray-500 dark:text-slate-400 text-base md:text-lg">{item.desc}</p>
            </div>
          )}
        />
      </div>
          ...
          >
            ...
            {[...testimonials, ...testimonials].map((t, i) => (
              <div key={i} className="w-[340px] md:w-[420px] flex-shrink-0">
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 md:p-8 text-center h-full flex flex-col items-center justify-center">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                    {t.initial}
                  </div>
                  <p className="text-gray-600 dark:text-slate-300 text-base md:text-lg mb-4 max-w-sm mx-auto italic">&ldquo;{t.text}&rdquo;</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
            Ace Every <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Interview</span> With Confidence
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/signup">
              <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-xl font-medium text-lg hover:from-orange-600 hover:to-red-600 transition-all duration-300 shadow-lg hover:shadow-orange-500/30 hover:-translate-y-0.5">
                Start Practicing Free
              </button>
            </Link>
            <button
              onClick={() => scrollToSection("how-it-works")}
              className="bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-gray-200 dark:border-slate-700 px-8 py-4 rounded-xl font-medium text-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-all duration-300 shadow-sm"
            >
              See How It Works
            </button>
          </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">3-in-1</div>
              <div className="text-sm text-gray-500 dark:text-slate-400 mt-1">Voice, Face & Vocab Analysis</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Real-time</div>
              <div className="text-sm text-gray-500 dark:text-slate-400 mt-1">Instant AI Feedback</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">LLM</div>
              <div className="text-sm text-gray-500 dark:text-slate-400 mt-1">Powered Coaching Reports</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 bg-slate-50/50 dark:bg-slate-900/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Everything You Need to <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Nail Your Interview</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 - Voice */}
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-2xl p-8 transition-all duration-300 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 hover:-translate-y-1">
            ...
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-2xl p-8 transition-all duration-300 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10 hover:-translate-y-1">
      ...
      <section id="how-it-works" className="py-20 bg-white dark:bg-slate-950 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              How <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Oratio</span> Works
            </h2>
            <p className="text-xl text-gray-600 dark:text-slate-400 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold text-lg z-10 shadow-lg">1</div>
              <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-8 h-full relative overflow-hidden group shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Ace Your Next <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Interview</span>?
          </h2>
          <p className="text-xl text-gray-600 dark:text-slate-400 mb-10 max-w-3xl mx-auto">
      ...
      {/* Footer */}
      <footer className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-t border-gray-200 dark:border-slate-800 pt-16 pb-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#features" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Features</a></li>
                <li><a href="#how-it-works" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">How It Works</a></li>
                <li><a href="#testimonials" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Testimonials</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">About Us</a></li>
                <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Blog</a></li>
                <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Privacy Policy</a></li>
                <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm">Terms of Service</a></li>
              </ul>
            </div>
          </div>
